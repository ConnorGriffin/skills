# workflow-continuation Specification

## Purpose
Define how agent workflows resume after decisions and helper results while preserving
real stop boundaries, inherited evidence, and separate executor and reviewer admission.
