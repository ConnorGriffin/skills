...
RELATIONSHIPS = {
    ...
    "code-review": {"uses": ["orchestrate"], "requirements": "`orchestrate` is an optional integration used for reviewer routing when installed; parallel-agent support recommended; GitHub CLI to fetch an originating issue; see [docs/review-round-mining.md](docs/review-round-mining.md) for the mined evidence behind the fix protocol and the round cap"},
    ...
    "plan-review": {"uses": ["orchestrate", "persona-review"], "requirements": "`orchestrate` is an optional integration used for reviewer routing when installed; parallel-agent support recommended; `persona-review` optional for load-bearing plans; the round-count evidence behind its rules is in [docs/review-round-mining.md](docs/review-round-mining.md)"},
